    ...
    try {
        ...
        if (userDocSnap.exists()) {
            ...
            if (!querySnapshot.empty) {
                ...
                console.log(`Score7 updated in latest attempt for user: ${user.uid}`);
            } else {
  ...
  var spanClass = userInput === correctAnswer ? 'correct' : 'incorrect';
        ...
        if (userInput === correctAnswer) {
            ...
            pauseTimer();
                    ...
                    setTimeout(() => {
                        window.location.href = 'https://guillianecantillas.github.io/_CodeCraft/Horror%20Files/IngameHorror9.html';
                    }, 12000);
