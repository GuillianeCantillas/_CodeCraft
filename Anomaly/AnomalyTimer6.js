document.addEventListener("DOMContentLoaded", function () {
   ...
   function updateButtonPositions() { 
        ...
        button1.style.left = `${containerRect.left + -780}px`;
        button1.style.top = `${containerRect.top + -200}px`; //Reset

        button2.style.left = `${containerRect.left + -700}px`;
    ...
    window.checkAnswer4 = function () {
        ...
        const correctAnswer = "enum";
        const spanClass = userInput === correctAnswer ? 'correct' : 'incorrect';
        const sentence = document.getElementById("sentence4");

        if (userInput === correctAnswer) {
            sentence.innerHTML = "<span class= '" + spanClass + "'>" + userInput + "</span> <span style='color: #1679AB;'>Level</span> {<br>" +
            "&nbsp; &nbsp; Easy,<br>" +
            "&nbsp; &nbsp; Medium,<br>" +
            "&nbsp; &nbsp; Hard<br>" +
            "}; <br><br>";
            ...
            setTimeout(() => {
             ...
             setTimeout(() => {
                window.location.href = "https://guillianecantillas.github.io/_CodeCraft/Anomaly/InGameAnomaly8END.html";
            }, 9000);

        } else {
                sesentence.innerHTML = "<span class= '" + spanClass + "'>" + userInput + "</span> <span style='color: #1679AB;'>Level</span> {<br>" +
                "&nbsp; &nbsp; Easy,<br>" +
                "&nbsp; &nbsp; Medium,<br>" +
                "&nbsp; &nbsp; Hard<br>" +
                "}; <br><br>";
    ...
    window.updateSentence4 = function () {
        ...
        const sentence = document.getElementById("sentence4");
        sentence.innerHTML = userInput + " <span style='color: #1679AB;'>Level</span> {<br>" +
            "&nbsp; &nbsp; Easy,<br>" +
            "&nbsp; &nbsp; Medium,<br>" +
            "&nbsp; &nbsp; Hard<br>" +
            "}; <br><br>";
    ...
    window.resetForm = function () {
        ...
        document.getElementById("sentence4").innerHTML = "____ <span style='color: #1679AB;'>Level</span> {<br>" +
        "&nbsp; &nbsp; Easy,<br>" +
        "&nbsp; &nbsp; Medium,<br>" +
        "&nbsp; &nbsp; Hard<br>" +
        "}; <br><br>";
