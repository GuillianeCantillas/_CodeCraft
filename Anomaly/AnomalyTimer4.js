    ...
    try {
        ...
        if (userDocSnap.exists()) {
            ...
            if (!querySnapshot.empty) {
                ...
                console.log(`Score4 updated in latest attempt for user: ${user.uid}`);
            } else {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let hintIndex = 0;
    const hints = [
    "Hint 1: The method you are looking for starts with an 'c'.",
    "Hint 2: can output various data types",
    "Hint 3: is followed by << which is used to send data to ____."];
    ...
    setTimeout(() => {
        ...
        if (userInput === correctAnswer) {
            sentence.innerHTML = "<span style='color: #FF7F3E;'>int</span> <span style='color: #1679AB;'>i</span> = <span style='color: #A2C579;'>0</span>;<br><br>" +
            "<span class= '" + spanClass + "'>" + userInput + "</span> <span style='color: #FF7F3E;'>(i < 5)</span> { <br>" +
            "&nbsp; &nbsp; <span style='color: #FF7F3E;'>cout</span> << <span style='color: #1679AB;'>i</span> << <span style='color: #FF7F3E;'>&quot;\n&quot;</span>;<br>" +
            "&nbsp; &nbsp; <span style='color: #1679AB;'>i++</span>;<br>" +
            "} <br><br></div>";
            ...
            setTimeout(() => {
             ...
             setTimeout(() => {
                window.location.href = "https://guillianecantillas.github.io/_CodeCraft/Anomaly/InGameAnomaly5.html";
            }, 9000);
    ...
    window.updateSentence4 = function () {
        ...
        const sentence = document.getElementById("sentence4");
        sentence.innerHTML = "<span style='color: #FF7F3E;'>int</span> <span style='color: #1679AB;'>i</span> = <span style='color: #A2C579;'>0</span>;<br><br>" +
            userInput + " <span style='color: #FF7F3E;'>(i < 5)</span> { <br>" +
            "&nbsp; &nbsp; <span style='color: #FF7F3E;'>cout</span> << <span style='color: #1679AB;'>i</span> << <span style='color: #FF7F3E;'>&quot;\n&quot;</span>;<br>" +
            "&nbsp; &nbsp; <span style='color: #1679AB;'>i++</span>;<br>" +
            "} <br><br></div>";
    };
    ...
    window.resetForm = function () {
        ...
        document.getElementById("sentence4").innerHTML = "<span style='color: #FF7F3E;'>int</span> <span style='color: #1679AB;'>i</span> = <span style='color: #A2C579;'>0</span>;<br><br>" +
            "_____<span style='color: #FF7F3E;'>(i < 5)</span> { <br>" +
            "&nbsp; &nbsp; <span style='color: #FF7F3E;'>cout</span> << <span style='color: #1679AB;'>i</span> << <span style='color: #FF7F3E;'>&quot;\n&quot;</span>;<br>" +
            "&nbsp; &nbsp; <span style='color: #1679AB;'>i++</span>;<br>" +
            "} <br><br></div>";
        document.getElementById("textbox").disabled = false;
