document.addEventListener("DOMContentLoaded", function () {
    ...
    "Hint 3: This code is followed by << which is used to send data to ____."];
    ...
    window.checkAnswer4 = function () {
        ...
        if (userInput === correctAnswer) {
            ...
            "<span style='color: #FF7F3E;'>using namespace std;</span><br><br>" +
            "<span style='color: #FF7F3E;'>int</span> <span style='color: #AF47D2;'>main()</span> {<br>" +
            "&nbsp; &nbsp; &nbsp;<span class= '" + spanClass + "'>" + userInput + "</span> << <span style='color: #A2C579;'>&quot;Marco&quot;</span><br>" +
            "&nbsp; &nbsp; &nbsp;<span style='color: #FF7F3E;'>return 0</span>;<br>" +
            "}<br><br></div>"; 
    ...
    window.updateSentence4 = function () {
        ...
        sentence.innerHTML =   "<br>" +
            ...
            "<span style='color: #FF7F3E;'>using namespace std;</span><br><br>" +
            "<span style='color: #FF7F3E;'>int</span> <span style='color: #AF47D2;'>main()</span> {<br>" +
            "&nbsp; &nbsp; &nbsp;" + userInput + " << <span style='color: #A2C579;'>&quot;Marco&quot;</span><br>" +
            "&nbsp; &nbsp; &nbsp;<span style='color: #FF7F3E;'>return 0</span>;<br>" +
            "}<br><br></div>"; 
    };
    ...
    window.resetForm = function () {
        ...
        document.getElementById("sentence4").innerHTML = "<br>" +
            "<span style='color: #FF7F3E;'>#include &lt;iostream&gt;</span> <br><br>" +
            "<span style='color: #FF7F3E;'>using namespace std;</span><br><br>" +
            "<span style='color: #FF7F3E;'>int</span> <span style='color: #AF47D2;'>main()</span> {<br>" +
            "&nbsp; &nbsp; &nbsp;____ << <span style='color: #A2C579;'>&quot;Marco&quot;</span><br>" +
            "&nbsp; &nbsp; &nbsp;<span style='color: #FF7F3E;'>return 0</span>;<br>" +
            "}<br><br></div>"; 
