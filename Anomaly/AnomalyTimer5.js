    ...
    try {
        ...
        if (userDocSnap.exists()) {
            ...
            if (!querySnapshot.empty) {
                ...
                console.log(`Score5 updated in latest attempt for user: ${user.uid}`);
            } else {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let hintIndex = 0;
    const hints = [
    "Hint 1: specify the type and size.",
    "Hint 2: Declaring it with multiple dimensions.",
    "Hint 3: Use const for read-only."];
    ...
    setTimeout(() => {
        ...
        if (userInput === correctAnswer) {
            ...
            sentence.innerHTML = "<span style='color: #FF7F3E;'>string</span> <span style='color: #1679AB;'>rooms</span> <span class= '" + spanClass + "'>" + userInput + "</span> = {<span style='color: #A2C579;'>&quot;Mac Lab&quot;, &quot;Physics Lab&quot;, &quot;Elevator&quot;, &quot;Classroom&quot;</span>}; <br><br></div>";
            ...
            setTimeout(() => {
             ...
             setTimeout(() => {
                window.location.href = "https://guillianecantillas.github.io/_CodeCraft/Anomaly/InGameAnomaly6.html";
            }, 9000);
    ...
    window.updateSentence4 = function () {
        ...
        const sentence = document.getElementById("sentence4");
        sentence.innerHTML = "<span style='color: #FF7F3E;'>string</span> <span style='color: #1679AB;'>rooms</span> " + userInput + " = {<span style='color: #A2C579;'>&quot;Mac Lab&quot;, &quot;Physics Lab&quot;, &quot;Elevator&quot;, &quot;Classroom&quot;</span>}; <br><br></div>";
     
    };

    window.resetForm = function () {
        document.getElementById("answerForm").reset();
        document.getElementById("sentence4").innerHTML = "<span style='color: #FF7F3E;'>string</span> <span style='color: #1679AB;'>rooms</span> ____ = {<span style='color: #A2C579;'>&quot;Mac Lab&quot;, &quot;Physics Lab&quot;, &quot;Elevator&quot;, &quot;Classroom&quot;</span>}; <br><br></div>";
        document.getElementById("textbox").disabled = false;
